...
enum WeekPlanMapper {
    ...
    static func migratedWeekPlan(from weekPlan: WeekPlan, fileModificationDate: Date? = nil) -> MigratedWeekPlan {
        ...
        return MigratedWeekPlan(
            ...
            isWeekComplete: weekPlan.isWeekComplete,
            weekCompletedAt: weekPlan.weekCompletedAt,
    ...
    static func weekPlan(from migrated: MigratedWeekPlan) -> WeekPlan {
        ...
        return WeekPlan(
            ...
            isWeekComplete: migrated.isWeekComplete,
            weekCompletedAt: migrated.weekCompletedAt,
